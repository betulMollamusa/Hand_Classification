...
# Sınıflandırıcıyı eğit (SVM kullanıldı)
classifier = SVC(probability=True)
classifier.fit(X_train_selected, Y_train)
# Çapraz doğrulama ile sınıflandırıcıyı değerlendir
cv_scores = cross_val_score(classifier, X_train_selected, Y_train, cv=5)  # 5 katlı çapraz doğrulama
